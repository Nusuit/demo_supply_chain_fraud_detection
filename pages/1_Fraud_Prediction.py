...
with tab1:
    ...
    <p style="font-size: 0.875rem; color: #5A5A5A; margin-bottom: 2rem;">
...
with tab2:
    ...
    <p style="font-size: 0.875rem; color: #5A5A5A; margin-bottom: 2rem;">
        File must contain 61 feature columns. Download sample and upload your data.
    </p>
    """, unsafe_allow_html=True)
    ...
    with col1:
        try:
            ...
            st.download_button(
                label="Download Sample File (sample_transactions.csv)",
                data=csv_sample,
